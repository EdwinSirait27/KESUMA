                            ...
                            <div class="col-md-3">
                                <div class="image view view-first">
                                    <img style="width: 100%; display: block;"
                                        src="{{ asset('storage/fotosiswa/' . $calon->siswa->foto) }}" alt="image" />
                                </div>
                                <div class="caption">
                            ...
                            <tbody>
                                ...
                                @foreach ($votingg as $data)
                                    <tr>
                                        ...
                                        <td>{{ $data->tanggal }}</td>
                                        <td>
                                            @if($data->users->hakakses === 'Admin' || $data->users->hakakses === 'Kurikulum'||$data->users->hakakses === 'Guru'||$data->users->hakakses === 'KepalaSekolah')
                                                Guru
